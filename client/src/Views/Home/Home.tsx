...
export const Home = () => {
    ...
    return (
        <div
            ...
            className="h-screen relative bg-gray-100 p-5 flex justify-center items-center bg-center bg-no-repeat bg-[url('../../assets/cricket-bg.jpg'})]"
        >
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                                Vajra Primier League 2025 - ScoreBook
                            </h3>
                        </div>
                        ...
                        <div className="p-4 md:p-5">
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-4">
                                <div
                                    className="flex items-center justify-center p-1 text-sm font-bold text-white rounded-lg bg-blue-500 hover:bg-blue-600 group hover:shadow cursor-pointer"
