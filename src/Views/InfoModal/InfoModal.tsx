                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <input
                                    ...
                                    className={`${errors.team1 &&
                                        ...
                                        } bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 py-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500`}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <select
                                    ...
                                    className={` ${errors.wonBy &&
                                        "focus:outline-none focus:border-red-700 bg-red-50 border border-red-500 text-red-900"
                                        }bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 py-1.5  dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500`}
                                    id="tossWonBy"
                                    defaultValue=""
