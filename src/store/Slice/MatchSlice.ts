...
export const matchSlice = createSlice({
    ...
    reducers: {
        ...
        add_batsman: (
            ...
            // console.log('getInnings:', current(getInnings));
            ...
            // }
            // console.log('batsman data state after:', current(getInnings))
        },
        add_bowler: (
            state: Match,
        ...
        switch_strike: (
            ...
            //console.log('changeStrikeData:', current(changeStrikeData));
            if (changeStrikeData) {
        ...
        add_score: (
            ...
            // console.log('addScoreToStrikerBatsman:', current(addScoreToStrikerBatsman))
        ...
        add_wicket: (
            ...
            console.log('addWicketToStrikerBowler:', addWicketToStrikerBowler);
        ...
        add_extras:(state: any, action: PayloadAction<{currentInning: string, extrasRuns: IExtrasTRuns, batsmanId: string, bowlerId: string}>) => {
			...
			switch(extrasRuns.Type) {
				...
				case "noBall":
					...
					if (addingScore && addExtrasToStrikerBowler) {
						...
						//add runs to score timeline
						addingScore?.timeline!.scoreTimeline?.push(filteredTimeline(extrasRuns.Type, extrasRuns.Runs));
					}
					break;
				case "byes":
				case "legByes":
        ...
        switch_inning: (state: Match,action: PayloadAction<{matchId: string, currentInning: string}>) => {
            const { matchId, currentInning} = action.payload;
            console.log('state:', current(state));
            state.inningNumber = (currentInning === 'inning1' ? 'inning2' : 'inning1');
           // console.log('getCurrentMatch:', getCurrentMatch);
        },
        reset: (state: any) => {
